                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            SizedBox(width:15),
                            InkWell(
                              onTap: updateTask(taskModel: data[index],taskTitle: data[index].taskTitle.toString(),task: data[index].task.toString(),date: data[index].date.toString(),time: data[index].time.toString(),colorsCell: data[index].colorsCell.toString(),selectedIndex: data[index].selectedIndex.toString()),
